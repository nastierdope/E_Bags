...
function validate_user_registration()
{
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if (!empty($errors)) {
            ...
            create_user($first_name, $last_name, $address, $username, $email, $password);
        }
    }
}

function create_user($first_name, $last_name, $address, $username, $email, $password)
{
    ...
    $sql .= "VALUES('$first_name','$last_name','$address','$username','$email','$password')";
    confirm(query($sql));
